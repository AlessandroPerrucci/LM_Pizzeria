        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item <?= (!$in_subdirectory && ($pagina_attiva ?? '') === 'about') ? 'active' : '' ?>">
                    <a href="<?= $link_prefix ?>about.php" class="nav-link">About</a>
                </li>
                <li class="nav-item <?= (!$in_subdirectory && ($pagina_attiva ?? '') === 'contact') ? 'active' : '' ?>">
                    <a href="<?= $link_prefix ?>contact.php" class="nav-link">Contact</a>
                </li>
                ...
                <li class="nav-item d-flex align-items-center">
                    <?php if (isset($_SESSION['user'])): ?>
                        ...
                        <a href="<?= $link_prefix ?>logout.php" class="btn btn-outline-light">Logout</a>
                    <?php else: ?>
                        <a href="<?= $link_prefix ?>login.php" class="btn btn-primary">Login</a>
                    <?php endif; ?>
                </li>
            </ul>
        </div>
