	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <div class="ml-3 d-none d-lg-block">
  				<a href="prenotazione.php" class="btn btn-outline-warning px-4 py-2 rounded-pill animate__animated animate__fadeInDown">
    			<span class="icon-calendar mr-2"></span> Prenota
  				</a>
			</div>
	      </div>
		  </div>
